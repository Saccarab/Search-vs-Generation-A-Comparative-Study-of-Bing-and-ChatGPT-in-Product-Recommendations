...
We call this a \textbf{flip-flop}.
...
(25.96\% vs.\ 25.91\%). Even when we restrict to the same prompt
across different runs, one in five additional URLs switches to
cited. The boundary between ``cite inline'' and ``show as
supplementary'' is not stable: the model reshuffles which links
earn inline citation and which are demoted to supplementary,
