...
\subsection{ChatGPT and Bing Overlap}
\label{sec:page-dist}
\label{sec:bing-page-dist}

Match counts in this section combine both cited and additional links.
...
The steep drop on Page~2 is consistent with the Bing pagination instability we documented in Section~\ref{sec:bing-pagination-instability}, where Page~1 of the consumer SERP often cuts short. Regardless, the concentration of matches on Page~1 shows how significant a role page rank plays in getting cited by ChatGPT.

\subsection{ChatGPT and Google Overlap}
...
\begin{tabular}{lrr}
\toprule
Rank & GPT Business & GPT Personal \\
\midrule
\textbf{1} & \textbf{88} & \textbf{168} \\
2 & 59 & 128 \\
3 & 34 & 145 \\
4 & 37 & 107 \\
5 & 41 & 112 \\
...
Personal shows roughly 2.7$\times$ the Google matches of Business across all ranks, again reflecting its multi-provider retrieval. Note that this distribution only covers $\sim$29 ranks because SerpApi returns fewer results than our Bing scrape.
