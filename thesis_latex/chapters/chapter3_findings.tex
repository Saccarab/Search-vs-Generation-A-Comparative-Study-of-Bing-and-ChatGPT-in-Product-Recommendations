...
All three LLMs show a top-rank preference that parallels human click-through behavior, but the curve is flatter: the top-3 ranks account for 45--50\% of Page-1 matches versus 68.7\% of human clicks. Gemini shows the steepest rank-1 concentration (23.0\%), while GPT Personal is the flattest---likely because drawing from two indices creates more rank diversity.
