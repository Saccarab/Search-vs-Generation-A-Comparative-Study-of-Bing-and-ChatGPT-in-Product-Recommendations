...
\end{axis}
\end{tikzpicture}
\caption{Plus on Bing: flatter profile.}
...
\end{axis}
\end{tikzpicture}
\caption{Plus on Google: top-rank concentration with Page~2 bump.}
...
Unsurfaced URLs can also be promoted, though at lower rates (8--17\%) and with a different profile: news articles and reference pages (primarily Wikipedia) dominate, and when promoted they skip the additional category almost entirely, going straight to cited.
