...
All three LLMs show a top-rank preference that parallels human click-through behavior, but the curve is flatter: top-3 shares range from 47.5\% (Gemini) to 62.6\% (GPT Business) versus 68.7\% for human clicks. GPT Business shows the strongest rank-1 signal (24.9\%), while Gemini is the flattest---its citations spread more evenly across ranks 1--7.
