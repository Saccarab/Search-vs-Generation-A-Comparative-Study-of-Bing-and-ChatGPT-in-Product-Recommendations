...
the spike would likely be substantially larger.
...
the gradual decline shows that an underlying ranking signal persists; these are not random results.
To put this in perspective: comparing cumulative match counts, our Bing rank~150 carries
roughly the same information as Google rank~25, and the entire 200-position Bing scrape
covers approximately what Google's top~29 ranks do.
